...
class KGFactory:
    ...
    def create_kg_extractor(method: Optional[str] = None,
        ...
        if extractor_type == KGExtractorTypeEnum.OPENROUTER:
            ...
            return OpenRouterKGExtractor(neo4j_handler, model = models.get("openrouter"), **kwargs)
